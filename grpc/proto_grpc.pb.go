...
func (c *chittyChatClient) PublishMessage(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*PublishResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ChittyChat.ChittyChat/PublishMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (x *chittyChatBroadcastClient) Send(m *BroadcastMessage) error {
...
func (c *chittyChatClient) Join(ctx context.Context, in *JoinRequest, opts ...grpc.CallOption) (*JoinResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ChittyChat.ChittyChat/Join", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChittyChat_PublishMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ChittyChat.ChittyChat/PublishMessage",
	}
...
func (x *chittyChatBroadcastServer) Recv() (*BroadcastMessage, error) {
...
func _ChittyChat_Join_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ChittyChat.ChittyChat/Join",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
